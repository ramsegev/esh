    ...
    return (
        <header className={classes.header}>
            <Grid container justifyContent="space-between" alignItems="center">
                ...
                <Grid item>
                    <IconButton aria-label="lang" onClick={() => handleChangeLanguage()}>
                        <FontAwesomeIcon icon={faGlobe}/> {/* I didnt have licenses for pro to get the thin icon */}
                    </IconButton>
                </Grid>
            </Grid>
        </header>
